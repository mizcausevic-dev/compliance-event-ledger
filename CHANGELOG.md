...
### Released
- Released **compliance-event-ledger** publicly as a reviewable operating system for ai retrieval reliability.
...
### Shipped
- Cut the first coherent internal version of **compliance-event-ledger** with stable domain objects, review surfaces, and decision outputs.
- Established the first reviewable version of the architecture described as: Java Spring Boot backend for immutable compliance event history, timeline retrieval, exception pressure scoring, and audit-friendly governance workflows
